  ...
  return (
    <>
            ...
            <tr>
              ...
              <td className="px-2 py-4">
                <div className="flex overflow-hidden border w-max rounded-lg">
                  ...
                  <button type="button" className="bg-gray-800 text-white flex items-center justify-center w-11 h-10 font-semibold">
      ...
      <div className="max-w-xl ml-auto">
        ...
        <button type="button" className="mt-6 text-base tracking-wide px-5 py-2.5 w-full bg-gray-800 hover:bg-gray-900 text-white rounded-lg">Make Payment</button>
      </div>
    </div>
    </>
  )
